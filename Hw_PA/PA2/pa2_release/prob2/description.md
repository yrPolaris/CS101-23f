...
* if $opt=1$, you need to insert $x(1\le x\le 10^{11})$ into your data structure and return $0$. 
* if $opt=2$, you need to erase $x$ from your data structure and return 0. It is guaranteed that there exists $1\le j\le m$ such that $s_j=x$. 
...
If you successfully pass all the set operations, our checker would call `void clear()`, where you can deconstruct your data structure and release your resources.
